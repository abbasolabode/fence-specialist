...
export default function AboutCompany() {
	...
	return (
		<div className="w-full min-h-[35rem] 2xl:w-[94.5rem] mx-auto">
			<div className="min-h-[20rem] w-full 2xl:flex 2xl:justify-around 2xl:w-[89.5rem] 2xl:min-h-[35rem]">
				{/* Left container */}
				<div className="w-full px-4 sm:px-0 sm:w-[24.375rem] min-h-[30rem] pt-10 flex flex-col items-center 2xl:w-[32rem] 2xl:px-0">
					<div className="w-full sm:w-[24.375rem] flex flex-col justify-center items-center 2xl:w-full 2xl:min-h-[35rem] 2xl:items-start">
						<h2 className="w-full sm:w-[19.875rem] text-center font-sourceSerif text-[1.8rem] text-dimGray 2xl:w-[32rem] 2xl:min-h-[6.1875rem] 2xl:text-left 2xl:text-[2.5rem] 2xl:font-lato 2xl:font-semibold 2xl:leading-100">
							Your
						...
						<p className="w-full sm:w-[22.4rem] pt-8 text-center text-dimGray font-sm leading-7 2xl:w-full 2xl:min-h-[14rem] 2xl:text-left 2xl:font-medium 2xl:leading-6 2xl:tracking-0.5">
				...
				{/* Right container */}
				<div className="w-full sm:w-[24.375rem] min-h-[24.1875rem] mt-[5rem] hidden 2xl:block 2xl:w-3/5 2xl:min-h-full">
					<div className="w-full min-h-[15rem] flex items-center gap-2 justify-center 2xl:min-h-full">
						<div className="w-full sm:w-[20.375rem] 2xl:min-h-[35rem] 2xl:w-[28rem]">
							<img
								src="/images/man with fence.png"
								alt="image of a man and fence"
								className="w-full min-h-[13rem] object-cover 2xl:min-h-full"
							/>
						</div>
						<div className="2xl:flex 2xl:flex-col 2xl:gap-[1rem] 2xl:w-[23.5rem] 2xl:min-h-[35rem]">
							<div className="w-full sm:w-[20.375rem]">
								<img
									src="/images/iron fence metal.png"
									alt="image of an iron metal fence"
									className="w-full min-h-[13rem] object-cover 2xl:min-h-[17rem]"
								/>
							</div>
							<div className="w-full sm:w-[20.375rem]">
								<img
